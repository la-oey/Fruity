---
title: "Fruity Exp1 in-lab Analysis"
author: "Lauren Oey"
date: "1/13/2019"
output: pdf_document
---
...
Full model has a significant effect of word ordering (as predicted), slight interaction between word ordering and scale and between word ordering, scale, and syntactic structure

No interaction between adjective ordering and syntactic structure is surprising but probably due to large number of variables
...
This is the model that should be reported. It just shows that adjective ordering is a significant predictor of selection.
